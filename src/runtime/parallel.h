...
par_array par_get(const par_array a, int (*f)(int i), int (*p)(int i, const par_array x, void* cmp), void* cmp);
...
par_array par_map1(double (*f)(double x), const par_array a, int (*p)(int i, const par_array x, void* cmp), void* cmp);
par_array par_map2(double (*f)(double x, double y), const par_array a, const par_array b, int (*p)(int i, const par_array x, const par_array y, void* cmp), void* cmp);
par_array par_map3(double (*f)(double x, double y, double z), const par_array a, const par_array b, const par_array c, int (*p)(int i, const par_array x, const par_array y, const par_array z, void* cmp), void* cmp);

double par_reduce(double (*f)(double x, double y), const par_array a, int (*p)(int i, const par_array x, void* cmp), void* cmp);
par_array par_scan(double (*f)(double x, double y), const par_array a, int (*p)(int i, const par_array x, void* cmp), void* cmp);


// Returns the number of elements that are SOME and that satisfies predicate p
int par_count(const par_array a, int (*p)(int i, const par_array x, void* cmp), void* cmp);
