...
PAR_OBJ=obj/par_threadpool.o obj/par_threading.o obj/par_parallel.o obj/par_reduce.o obj/par_concat.o obj/par_get.o
#obj/par_map.o
...
temp: test_reduce test_concat test_communication
